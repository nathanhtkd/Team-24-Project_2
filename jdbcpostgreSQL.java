...
public class jdbcpostgreSQL {
  ...
  public static void main(String args[]) {
    ...
    try {
     ...
     String csvFilePath = "/Users/dongyingchen/Pictures/Book1.csv";
     try{
       //create a statement object
       //Running a query
       //TODO: update the sql command here
       String sqlStatement = "INSERT INTO teammembers (student_name,section,favorite_movie,favorite_holiday) VALUES(?,?,?,?)";
